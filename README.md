...
Lucide is a free, open-source icon set with over 1450+ icons(0.408.0), derived from the popular Feather icon set. It's available as a Flutter package for easy integration. Featuring a clean, modern design, it's perfect for enhancing user interfaces.
...
Lucide Version [0.408.0](https://github.com/lucide-icons/lucide/releases/tag/0.408.0).
